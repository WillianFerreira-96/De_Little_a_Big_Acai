...
function EstoqueFilter({ onFormFilter }) {
    ...
    return (
        <>
            <aside className="d-flex flex-row fixed-left">
                    ...
                    <div className="offcanvas-body">{/*<!--OffCanvas Body-->*/}
                        <form ref={formFiltro} onSubmit={dadosFormulario}>
                            <div className='d-flex justify-content-between'>
                                ...
                                <button type='button' ref={btnLimparRef} id="limparFiltro" className="btn btn-outline col-4 btn-sm mb-3">Limpar filtro</button>
                            </div>
                            <div id='divOverflow' className='pe-3'>

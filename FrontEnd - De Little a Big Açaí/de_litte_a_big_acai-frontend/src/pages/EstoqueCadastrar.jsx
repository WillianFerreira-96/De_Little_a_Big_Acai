...
function EstoqueCadastrar() {
    ...
    return <>
        <main className="container d-flex">
            <div className="row">
                <div id="divCadastro" className="ps-4 pe-4 bg-light col-12 col-lg-6 ">
                    <div>
                        <h2 className="mt-5 ms-5">Cadastrar Novo Item</h2>
                        <form id="formulario" className="bg-light p-5" enctype="multipart/form-data">
                            ...
                            <div className="form-floating mb-3">{/*<!--Nome-->*/}
                                <input type="text" className="form-control" id="nomeItem" name="nomeItem" />
                            ...
                            <button type="submit" className="btn btn-outline-primary mt-4 col-12 fw-bold">Cadastrar</button>
                        </form>
                    </div>
                </div>
                <div id="divLogo" className="d-none d-lg-flex col-lg-6 justify-content-center align-items-center ps-5">
                    <img className="shadow p-2 rounded ms-5" src="/img/logo_little_acai.png" alt="" />
                </div>
            </div>
        </main>
    </>
